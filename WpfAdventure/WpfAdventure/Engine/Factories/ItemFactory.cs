...
namespace Engine.Factories
{
    public static class ItemFactory
    {
        ...
        private static void LoadItemsFromNodes(XmlNodeList nodes)
        {
            ...
            {
                GameItem.ItemCategory itemCategory = DeterminateItemCategory(node.Name);
         ...
         private static GameItem.ItemCategory DeterminateItemCategory(string itemType)
         {
            switch (itemType)
            {
                case "Weapon":
        ...
        //    weapon.Action = new Actions.AttackWithWeapon(weapon, minimumDamage, maximumDamage);
