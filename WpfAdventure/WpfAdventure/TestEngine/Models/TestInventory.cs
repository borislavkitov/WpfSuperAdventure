...
namespace TestEngine.Models
{
    ...
    public class TestInventory
    {
        ...
        public void Test_CategorizedItemProperties()
        {
            ...
            Inventory inventory1 =
                inventory.AddItemFromFactory(1001);
        ...
        public void Test_RemoveItemQuantities()
        {
            ...
            Inventory inventory3 =
                inventory2.RemoveItems(new List<ItemQuantity> { new ItemQuantity(1002, 2) });
        ...
        public void Test_RemoveItemQuantities_RemoveTooMany()
        {
            ...
            //since we are trying to remove too many items than exist in the inventory
            Inventory inventory3 =
                inventory2
                .RemoveItems(new List<ItemQuantity> { new ItemQuantity(1001, 999) });
